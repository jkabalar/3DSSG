...
if __name__ == '__main__':
    ...
    pth_pd = '/home/julia/Desktop/SceneGraphFusion/build/'
    pth_pd = os.path.join(pth_pd,'predictions.json')
    pth_data_3rscan  = '/home/julia/Desktop/3DSSG/data/all'
    ...
    gts,classNames,predicateNames = load_both(pth_data_3rscan)
    ...
    while len(unique_colors) < len(classNames):
        unique_colors.add(generate_color())
